...
public class BrachytusAttackGoal extends MeleeAttackGoal {
    private final BrachytusEntity entity;
    private int attackDelay = 20;
    private int ticksUntilNextAttack = 20;
    private boolean shouldCountTillNextAttack = false;
    public BrachytusAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super (mob, speed, pauseWhenMobIdle);
        entity = ((BrachytusEntity)mob);
    }
