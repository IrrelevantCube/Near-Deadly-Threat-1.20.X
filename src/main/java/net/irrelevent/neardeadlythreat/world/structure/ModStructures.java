package net.irrelevent.neardeadlythreat.world.structure;
...
public class ModStructures {
    ...
    public static void registerStructureFeatures() {
        SKY_STRUCTURES = Registry.register(Registries.STRUCTURE_TYPE, new Identifier(NearDeadlyThreat.MOD_ID, "sky_structures"), () -> SkyStructures.CODEC);
     }
}